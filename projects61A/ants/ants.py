...
class Place(object):
    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # BEGIN Problem 11
                current_bodygaurd = self.ant.can_contain(insect) 
                add_bodygaurd = insect.can_contain(self.ant)
                

                if current_bodygaurd:
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if insect.name == 'Queen' and insect.impostor == False:
                return 
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        ant_place = self.place.ant
        
        return ant_place is not None and ant_place.blocks_path
...
class Ant(Insect):
    ...
    def can_contain(self, other):
        # BEGIN Problem 11
        if other.container == False and self.container == True and self.ant == None:
                    return True
        return False
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while this_place != hive:
            ...
            if len(this_place.bees) != 0 and counter >= self.min_range and counter <= self.max_range:
...
class NinjaAnt(Ant):
    ...
    def action(self, colony):
        # BEGIN Problem 8
        [bees.reduce_armor(self.damage) for bees in self.place.bees[:]]
        # END Problem 8
...
class HungryAnt(Ant):
    ...
    def eat_bee(self, bee):
        # BEGIN Problem 10
            if self.place.bees != [] and bee != None:
...
# END Problem 13
    ...
    implemented = True
    food_cost = 7
    lst = []    # Change to True to view in the GUI
    # END Problem 13
    ...
    def action(self, colony):
        ...
        if self.impostor:
            ...
            while ptr.exit != None:
                ptr = ptr.exit
                ty = [ptr.ant]
                if ptr.ant and ptr.ant.container:
                    ty.append(ptr.ant.ant)
                for x in ty:
                    if x and not x.doubled:
                        x.doubled = True
                        x.damage = x.damage * 2
...
def apply_effect(effect, bee, duration):
    ...
    # BEGIN Problem EC
    changed = effect(bee.action)
    unchanged = bee.action
