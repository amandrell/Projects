...
(define function (lambda y (* 2 y)))
; expect function
(lambda (x y z) (* x y z))
; expect (lambda (x y z) (* x y z))

(define (division x) (/ x x))
; expect division
division
; expect (lambda (x) (/ x x))
...
(cond ((= 3 3) 'here (define value_b 4) 42 (* value_b 3))
     (else 'wat 0))
; expect 12
...
(define delta (mu (x) (* x y) ))

(define gamma (lambda (x y) (delta (* x y))))
