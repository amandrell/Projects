...
def make_restaurant(name, location, categories, price, reviews):
    ...
    restaurant = {'restaurant_name': name, 'location': location, 'categories': categories, 'price': price, 'customer_reviews': reviews}
...
def restaurant_ratings(restaurant):
    ...
    # BEGIN Question 2
    return [review_rating(rev) for rev in restaurant['customer_reviews']]
    # END Question 2